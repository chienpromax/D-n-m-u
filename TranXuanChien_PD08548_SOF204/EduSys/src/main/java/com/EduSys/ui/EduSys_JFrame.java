...
//    private void showTabWithIdentity(String tabIdentity) {
//        for (int i = 0; i < tabs.getTabCount(); i++) {
//            String tabTitle = tabs.getTitleAt(i); // Lấy tiêu đề của tabpanel
//            if (tabTitle.equals(tabIdentity)) {
//                tabs.setSelectedIndex(i); // Hiển thị tabpanel tương ứng
//                break;
//            }
//        }
//    }
